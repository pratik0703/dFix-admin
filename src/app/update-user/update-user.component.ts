...
export class UpdateUserComponent implements OnInit {
  constructor(public http:Http, public route: Router,public dialog:MatDialog, private modalService: NgbModal)
  {
  ...
  this.http.post('http://localhost:3333/api/delete-user', {
       user: users
     })
       .subscribe(
         res => {
